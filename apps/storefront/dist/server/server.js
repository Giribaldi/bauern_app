...
const NodeResponse = /* @__PURE__ */ (() => {
  ...
  class NodeResponse2 {
    ...
    _toNodeResponse() {
      ...
      const headers = [];
      const initHeaders = (_a4 = __privateGet(this, _init2)) == null ? void 0 : _a4.headers;
      const headerEntries = ((_b3 = __privateGet(this, _response)) == null ? void 0 : _b3.headers) || __privateGet(this, _headers2) || (initHeaders ? Array.isArray(initHeaders) ? initHeaders : (initHeaders == null ? void 0 : initHeaders.entries) ? initHeaders.entries() : Object.entries(initHeaders) : void 0);
...
async function getStartManifest(matchedRoutes) {
  var _a3;
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CtH7G9T_.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-Zlf4ePTq.js"),
